(() => {
    ...
    function initSliders() {
        if (document.querySelector(".gallery__body")) new swiper_core_Swiper(".gallery__body", {
        ...
        if (document.querySelector(".model__body")) new swiper_core_Swiper(".model__body", {
            modules: [ Navigation, Pagination, EffectFade ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            navigation: {
                prevEl: ".model-btn-prev",
                nextEl: ".model-btn-next"
            },
            on: {}
        });
    }
